...
// Import data
import bgLectures from '@/data/bg_lectures.json';
import sbLectures from '@/data/sb_lectures.json';
import nodLectures from '@/data/nod_lectures.json';
...
// Recent Lecture Card
function RecentLectureCard({ lecture }: { lecture: Lecture }) {
  return (
...
export default function Dashboard() {
  ...
  const allLectures = [...bgLectures, ...sbLectures, ...nodLectures] as Lecture[];
    ...
    <div className="py-4">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-foreground-muted">
          Track your spiritual journey through Srila Prabhupada&apos;s lectures
        </p>
      </div>
